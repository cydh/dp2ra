...
class Items
{
    ...
    public function __construct(array $params = [])
    {
        ...
        $this->input_file = isset($params["input"]) ? $params["input"] : "item_db.json";
        $this->out_itemdb_file = isset($params["output_itemdb"]) ? $params["output_itemdb"] : "item_db.txt";
        $this->out_moveinfo_file = isset($params["output_tradedb"]) ? $params["output_tradedb"] : "item_trade.txt";
    ...
    private function writeTradeFlag()
    {
        if (isset($this->data["itemMoveInfo"]) && $this->data["itemMoveInfo"] !== null) {
            $flag = DPParser::tradeFlag($this->data["itemMoveInfo"]);
            fputs($this->out_moveinfo_fp, "".$this->id.",".$flag."\t// ".$this->data["name"]."\r\n");
        }
    }
